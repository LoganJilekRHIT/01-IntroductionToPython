...
blue_pen_turtle = rg.SimpleTurtle('turtle')
blue_pen_turtle.pen = rg.Pen('blue', 3)
blue_pen_turtle.speed = 7
blue_pen_turtle.left(90)
blue_pen_turtle.forward(200)
blue_pen_turtle.pen_up()
blue_pen_turtle.go_to(rg.Point(100,-40))
blue_pen_turtle.pen_down()
blue_pen_turtle.pen = rg.Pen('green', 10)
blue_pen_turtle.backward(150)
